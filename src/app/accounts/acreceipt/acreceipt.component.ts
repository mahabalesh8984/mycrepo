...
@Component({
  ...
  selector: 'app-acreceipt',
  templateUrl: './acreceipt.component.html',
  styleUrls: ['./acreceipt.component.css','../../shared/myc.style.css'],
...
export class AcreceiptComponent implements OnInit {
  ...
  //  matcher = new MyErroracreceipt();
    ...
    displayedColumns = ['action','depnm','insnm', 'amount','paid','balance','act2','act3'];
stuid:number=0;
