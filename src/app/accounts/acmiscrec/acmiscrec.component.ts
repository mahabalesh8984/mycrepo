...
@Component({
  ...
  selector: 'app-acmiscreceipt',
  templateUrl: './acmiscrec.component.html',
  styleUrls: ['../../shared/myc.style.css','./acmiscrec.component.css'],
...
export class AcmiscrecsComponent implements OnInit {
